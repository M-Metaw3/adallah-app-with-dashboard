...
const { handlingMyFunction, isThisIdExistInThisModel } = require('../helper')
// const lawyerModel = require('../../db/models/lawyer.model')
...
class Consultation {
    ...
    static respondConsultation = async (req, res) => {
        Helper.handlingMyFunction(req, res, (req) => {
            const consultation = isThisIdExistInThisModel(req.params.id, consultationModel, 'consultation', { path: 'lawyerDetails', populate: { path: 'userData' } })
    ...
    static acceptProduction = (req, res) => {
        Helper.formatMyAPIRes(req, res, async (req) => {
            const consultation = await isThisIdExistInThisModel(req.params.id, consultationModel, 'consultation')
